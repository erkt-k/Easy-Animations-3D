...
public class EasyRb2DLocalPath : EasyAnimation
{
    ...
    public override Tween Play()
    {
        ...
        m_tw = m_rb.DOLocalPath(m_wayPoints.ToArray(), m_duration, m_pathType, m_pathMode, m_resolution, m_gizmoColor)
                ...
                .OnComplete(() =>
                {
                    ...
                    if (m_doesReturnHome) m_rb.DOLocalPath(m_wayPoints.ToArray(),
